...
const config = {
  title: 'MoLibrary Documentation',
  tagline: 'A comprehensive .NET library collection',
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/Euynac/MoLibrary/tree/main/website/',
        },
        blog: {
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} MoLibrary Project. Built with Docusaurus.`,
      },
      prism: {

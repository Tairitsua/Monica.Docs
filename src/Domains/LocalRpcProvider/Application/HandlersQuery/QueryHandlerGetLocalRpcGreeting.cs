...
/// </summary>
public sealed class QueryHandlerGetLocalRpcGreeting(ILoggerFactory loggerFactory)
    : ApplicationService<GetLocalRpcGreetingRequest, LocalRpcGreetingDto>(loggerFactory)
{
    /// <summary>

...
```
 "ExceptionObject": "[FORCE]System.AggregateException: Some services are not able to be constructed (Error while validating the service descriptor 'ServiceType: MoLibrary.Framework.Services.IFrameworkMonitorService Lifetime: Scoped ImplementationType: MoLibrary.Framework.Services.FrameworkMonitorService': Unable to resolve service for type 'MoLibrary.EventBus.Abstractions.IMoDistributedEventBus' while attempting to activate 'MoLibrary.Framework.Services.FrameworkMonitorService'.) (Error while validating the service descriptor 'ServiceType: MoLibrary.Configuration.Dashboard.UIConfiguration.Services.ConfigurationClientService Lifetime: Scoped ImplementationType: MoLibrary.Configuration.Dashboard.UIConfiguration.Services.ConfigurationClientService': Unable to resolve service for type 'MoLibrary.Configuration.Dashboard.Interfaces.IMoConfigurationModifier' while attempting to activate 'MoLibrary.Configuration.Dashboard.UIConfiguration.Services.ConfigurationClientService'.) (Error while validating the service descriptor 'ServiceType: MoLibrary.Configuration.Dashboard.UIConfiguration.Services.ConfigurationDashboardService Lifetime: Scoped ImplementationType: MoLibrary.Configuration.Dashboard.UIConfiguration.Services.ConfigurationDashboardService': Unable to resolve service for type 'MoLibrary.Configuration.Dashboard.Interfaces.IMoConfigurationCentre' while attempting to activate 'MoLibrary.Configuration.Dashboard.UIConfiguration.Services.ConfigurationDashboardService'.) (Error while validating the service descriptor 'ServiceType: MoLibrary.UI.Services.MoThemeService Lifetime: Singleton ImplementationType: MoLibrary.UI.Services.MoThemeService': Cannot consume scoped service 'Microsoft.Extensions.Options.IOptionsSnapshot`1[MoLibrary.UI.Modules.ModuleUICoreOption]' from singleton 'MoLibrary.UI.Services.MoThemeService'.) (Error while validating the service descriptor 'ServiceType: MoLibrary.SignalR.Controllers.ModuleSignalRController Lifetime: Transient ImplementationType: MoLibrary.SignalR.Controllers.ModuleSignalRController': Unable to resolve service for type 'MoLibrary.SignalR.Controllers.MoSignalRManageService' while attempting to activate 'MoLibrary.SignalR.Controllers.ModuleSignalRController'.)
 ---> System.InvalidOperationException: Error while validating the service descriptor 'ServiceType: MoLibrary.Framework.Services.IFrameworkMonitorService Lifetime: Scoped ImplementationType: MoLibrary.Framework.Services.FrameworkMonitorService': Unable to resolve service for type 'MoLibrary.EventBus.Abstractions.IMoDistributedEventBus' while attempting to activate 'MoLibrary.Framework.Services.FrameworkMonitorService'.

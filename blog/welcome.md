...
我们很高兴向您介绍 Monica，这是一个模块化的 .NET 基础设施库，旨在提供可独立使用的组件，帮助您快速构建高质量的应用程序。

## 为什么选择 Monica？

Monica 的核心设计理念是模块化和可组合性。我们不希望您为了使用某个特定功能而引入整个繁重的框架，因此每个模块都可以独立使用，同时又能与其他模块协同工作。
...
我们欢迎您的贡献和反馈！请访问我们的 [GitHub 仓库](https://github.com/Euynac/Monica) 了解更多信息。 